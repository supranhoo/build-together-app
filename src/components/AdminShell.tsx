...
import { Calculator, Cog, FlaskConical, LayoutDashboard, LogOut, Menu, ShieldCheck, ShoppingCart, Users } from "lucide-react";
...
export const adminNavItems = [
  ...
  { label: "User Management", to: "/admin/system-control?tab=users", icon: Users },
